  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      <motion.div variants={item} className="space-y-4">
        <h1 className="text-3xl md:text-4xl font-bold text-[#503E24]">SANCTUM: THE LONGEVITY SANCTUARY</h1>
      ...
      <motion.div variants={item} className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-[#B68D53]/20">
          <CardContent className="p-6 space-y-4">
            <h3 className="text-xl font-bold text-[#503E24]">Welcome to Sanctum</h3>
        ...
        <Card className="border-[#B68D53]/20">
          <CardContent className="p-6 space-y-4">
            <h3 className="text-xl font-bold text-[#503E24]">Innovative Longevity Clinic</h3>
            <p className="text-[#503E24]/80">
        ...
        <Card className="border-[#B68D53]/20">
          <CardContent className="p-6 space-y-4">
            <h3 className="text-xl font-bold text-[#503E24]">A Serene Tropical Haven</h3>
            <p className="text-[#503E24]/80">
      ...
      <motion.div variants={item}>
        <h2 className="text-2xl font-bold text-[#503E24] mb-6">WORLD-CLASS FACILITIES</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-[#B68D53]/20 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-[#503E24]">Farm-to-Table</h3>
                <p className="text-[#503E24]/80">
          ...
          <Card className="border-[#B68D53]/20 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-[#503E24]">State-of-the-Art Gym</h3>
                <p className="text-[#503E24]/80">
          ...
          <Card className="border-[#B68D53]/20 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-[#503E24]">Luxury Spa</h3>
                <p className="text-[#503E24]/80">
