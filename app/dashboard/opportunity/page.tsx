    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      ...
      <motion.div variants={item}>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white border-[#B68D53]/20 w-full justify-start">
            <TabsTrigger
              value="overview"
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card className="bg-white border-[#B68D53]/20">
              <CardHeader>
                <CardTitle className="text-[#503E24]">Investment Highlights</CardTitle>
                <CardDescription className="text-[#503E24]/70">Key reasons to invest in Sanctum Bali</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-[#503E24]">Market Opportunity</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-[#503E24]">Competitive Advantages</h3>
                    <ul className="space-y-2 text-[#503E24]/80">
                      <li className="flex items-start gap-2">
                        <span className="text-[#B68D53] font-bold">•</span>
          ...
          <TabsContent value="metrics" className="space-y-6">
            <Card className="bg-white border-[#B68D53]/20">
              <CardHeader>
                <CardTitle className="text-[#503E24]">Key Financial Metrics</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">23%</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">IRR</h3>
                    <p className="text-[#503E24]/70">
                      Exceptional Internal Rate of Return, demonstrating the strong investment potential of Sanctum.
                    </p>
                  </div>
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">45%</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">EBITDA Margin</h3>
                    <p className="text-[#503E24]/70">
                  ...
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">13%</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">CAGR</h3>
                    <p className="text-[#503E24]/70">
                      Compound Annual Growth Rate, delivering strong double-digit growth year over year.
                    </p>
                  </div>
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">&lt; 5 yrs</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">Payback Period</h3>
                    <p className="text-[#503E24]/70">Time to recover each tranche of capital investment.</p>
                  </div>
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">$40.4M</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">Total Return</h3>
                    <p className="text-[#503E24]/70">
                      Total Return on Investment, providing an Equity Multiple of 3.45
                    </p>
                  </div>
                  <div className="bg-[#F8F5F0] p-6 rounded-lg">
                    <div className="text-[#B68D53] text-4xl font-bold mb-2">$11.7M</div>
                    <h3 className="text-[#503E24] text-xl font-semibold mb-2">Total Investment</h3>
                    <p className="text-[#503E24]/70">Capital required to fully develop and launch Sanctum Bali.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="structure" className="space-y-6">
            <Card className="bg-white border-[#B68D53]/20">
              <CardHeader>
                ...
                <CardDescription className="text-[#503E24]/70">
                  Equity distribution and investment terms
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold text-[#503E24] mb-4">Equity Distribution</h3>
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-xl font-semibold text-[#503E24] mb-4">Investment Terms</h3>
                      <ul className="space-y-4 text-[#503E24]/80">
                        <li className="flex items-start gap-2">
                          <span className="text-[#B68D53] font-bold">•</span>
                          <div>
          ...
          <TabsContent value="timeline" className="space-y-6">
            <Card className="bg-white border-[#B68D53]/20">
              <CardHeader>
                <CardTitle className="text-[#503E24]">Investment Timeline</CardTitle>
                <CardDescription className="text-[#503E24]/70">Development and investment milestones</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="relative">
                  <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-[#B68D53]/30"></div>
                  <div className="space-y-8 relative">
                    <div className="relative pl-10">
                      <div className="absolute left-0 top-1 w-8 h-8 rounded-full bg-[#B68D53] flex items-center justify-center text-white font-bold">
                        1
                      </div>
                      <h3 className="text-xl font-semibold text-[#503E24] mb-2">2025: Initial Investment</h3>
                      <p className="text-[#503E24]/80 mb-2">$4.5M capital contribution for:</p>
                      <ul className="space-y-1 text-[#503E24]/80">
                        <li className="flex items-start gap-2">
                          <span className="text-[#B68D53] font-bold">•</span>
                    ...
                    <div className="relative pl-10">
                      ...
                      <h3 className="text-xl font-semibold text-[#503E24] mb-2">2026: Construction Phase</h3>
                      <p className="text-[#503E24]/80 mb-2">$4.9M capital contribution for:</p>
                      <ul className="space-y-1 text-[#503E24]/80">
                        <li className="flex items-start gap-2">
                          <span className="text-[#B68D53] font-bold">•</span>
                    ...
                    <div className="relative pl-10">
                      ...
                      <h3 className="text-xl font-semibold text-[#503E24] mb-2">2027: Launch & Operations</h3>
                      <p className="text-[#503E24]/80 mb-2">$2.3M capital contribution for:</p>
                      <ul className="space-y-1 text-[#503E24]/80">
                        <li className="flex items-start gap-2">
                          <span className="text-[#B68D53] font-bold">•</span>
                    ...
                    <div className="relative pl-10">
                      ...
                      <h3 className="text-xl font-semibold text-[#503E24] mb-2">2028-2034: Growth & Returns</h3>
                      <p className="text-[#503E24]/80 mb-2">Projected returns:</p>
                      <ul className="space-y-1 text-[#503E24]/80">
                        <li className="flex items-start gap-2">
                          <span className="text-[#B68D53] font-bold">•</span>
