  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      <motion.div variants={item} className="space-y-4">
        <h1 className="text-3xl md:text-4xl font-bold text-[#503E24]">GLOBAL EXPANSION</h1>
      ...
      <motion.div variants={item}>
        <Card className="border-[#B68D53]/20">
          <CardContent className="p-6 space-y-4">
            <h3 className="text-xl font-bold text-[#503E24]">Expansion Strategy</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F8F5F0] p-4 rounded-lg">
                <p className="font-bold text-[#503E24]">Phase 1: Bali</p>
                <p className="text-[#503E24]/80">Establish flagship location and refine operational model</p>
              </div>
              <div className="bg-[#F8F5F0] p-4 rounded-lg">
                <p className="font-bold text-[#503E24]">Phase 2: Global Expansion</p>
                <p className="text-[#503E24]/80">Strategic rollout to four key international locations</p>
              </div>
              <div className="bg-[#F8F5F0] p-4 rounded-lg">
                <p className="font-bold text-[#503E24]">Phase 3: Brand Network</p>
                <p className="text-[#503E24]/80">Establish Sanctum as a global wellness and longevity brand</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <motion.div variants={item}>
        <h2 className="text-2xl font-bold text-[#503E24] mb-6">FUTURE LOCATIONS</h2>
            ...
            <Card key={index} className="border-[#B68D53]/20">
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#503E24]">{location.name}</h3>
                    <p className="text-sm text-[#503E24]/60">{location.year}</p>
                  </div>
                </div>
                <p className="text-[#503E24]/80">{location.description}</p>
                <div className="flex flex-wrap gap-2">
                  {location.features.map((feature, idx) => (
                    <span key={idx} className="bg-[#F8F5F0] px-3 py-1 rounded-full text-sm text-[#503E24]">
                      {feature}
                    </span>
                  ))}
                </div>
        ...
        <Card className="border-[#B68D53]/20">
          <CardContent className="p-6">
            <div className="text-center space-y-4">
              <h3 className="text-2xl font-bold text-[#503E24]">365-DAY WELLNESS PLATFORM</h3>
